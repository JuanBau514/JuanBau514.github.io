...
function encriptar(textoAEncriptar) {
    ...
    for (let i = 0; i < textoAEncriptar.length; i++) {
        textoEncriptado += String.fromCharCode(textoAEncriptar.charCodeAt(i)+14); // suma 14 al codigo ascii del caracter y lo convierte a caracter
    }
...
function desencriptar(textoADesencriptar) {
    ...
    for (let i = 0; i < textoADesencriptar.length; i++) {
        textoDesencriptado += String.fromCharCode(textoADesencriptar.charCodeAt(i)-14); // resta 14 al codigo ascii del caracter y lo convierte a caracter
    }
